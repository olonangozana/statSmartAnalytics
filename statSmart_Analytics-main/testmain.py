            ...
            if result :
                    ...
                    if task == "Data Overview":
                        ...
                        if uploaded_file is not None:
                            ...
                            tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["Remove Duplicates","Handling Missing Data","Change Datatypes","Change Timestamp","Drop Column","Rename Column","Save Dataset"])

                            # Check for duplicates
                            with tab1:
                                st.header("1. Remove Duplicates")
